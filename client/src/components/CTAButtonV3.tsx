...
interface CTAButtonV3Props {
  label?: string;
  className?: string;
}

export const CHECKOUT_URL_V3 = "https://pay.onprofit.com.br/P5JlkAul?off=HdAKm1";

export default function CTAButtonV3({
  ...
  return (
    ...
    >
      <a href={getCheckoutUrlWithUtms(CHECKOUT_URL_V3)} target="_blank" rel="noopener noreferrer">
        {label}
